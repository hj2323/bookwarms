...
<hr />
    ...
    <table class="table">
      ...
      <table class="table">
          <tbody>
            <tr>
              <td width="15%"><img src="${book.thumbImg }" width="100px"></td>
              <td><b>${book.book_title }</b></td>
              <td>수량<b> ${amount }</b>개</td>
              <input type="hidden" value="${amount }" name="amount">
              <td>총<b> <fmt:formatNumber type="number" maxFractionDigits="3" value="${book.book_price *amount }" />
							</b>원</td>
							<input type="hidden" value="${book.book_price *amount }" name="order_price">
            </tr>            
          </tbody>
        </table>
          ...
          <table class="table">
              <tbody>
                <tr>
                  ...
                  <td><fmt:formatNumber type="number" maxFractionDigits="3" value="${book.book_price *amount }" />원</td>
                </tr>
                <tr>
                    <td>결제방법 </td>
                    <td><div class="form-check-inline">
                        <label class="form-check-label">
                          <input type="radio" class="form-check-input" name="order_payment" value="계좌이체">계좌이체
                        </label>
                      </div>
                      <div class="form-check-inline">
                        <label class="form-check-label">
                          <input type="radio" class="form-check-input" name="order_payment" value="신용카드">신용카드
                        </label>
                      </div>
                      <div class="form-check-inline">
                        <label class="form-check-label">
                          <input type="radio" class="form-check-input" name="order_payment" value="체크카드">체크카드
                        </label>
                      </div>
                      <div class="form-check-inline">
                        <label class="form-check-label">
                          <input type="radio" class="form-check-input" name="order_payment" value="법인카드">법인카드
                        </label>
                      </div>
                      <div class="form-check-inline">
                        <label class="form-check-label">
                          <input type="radio" class="form-check-input" name="order_payment" value="휴대폰">휴대폰
                        </label>
                      </div>
                      <div class="form-check-inline">
                        <label class="form-check-label">
                          <input type="radio" class="form-check-input" name="order_payment" value="무통장입금(가상계좌)">무통장입금(가상계좌)
                        </label>
                      </div>
